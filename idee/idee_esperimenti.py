...
#     else:
#         # stabilisce la variabile per il 30% delle ricette
#         percent_items_to_show = 0.3
...
#         # ottieni solo la percentuale delle ricette
#         elenco_ricette = Ricetta.query.limit(items_to_show_count)
#
